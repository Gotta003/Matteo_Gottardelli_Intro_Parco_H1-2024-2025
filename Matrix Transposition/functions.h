...
//Using the floating number in order to be sure preciser equality I going to use the absolute value of the difference of the two higher than a low error
#define ERROR 1e-6
